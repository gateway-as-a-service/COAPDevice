...
class CoAPSubscriber(Resource):
    ...
    def __init__(self, name, device_info, hub_address="10.0.75.1"):  # TODO: Remove this hardcode for hub_address
        ...
        self.coap_sender_message = CoAPMessageSender(self.hub_address, GASS_COAP_MICROSERVICE_PORT, self.logger)
    ...
    def render_PUT(self, request):
        ...
        self.logger.info(
            "Send message {} to the coap micro-service at path: {}"
                .format(message_to_send_to_gateway, GASS_COAP_MICROSERVICE_PATH)
        )
        self.coap_sender_message.send_message_put(GASS_COAP_MICROSERVICE_PATH, message_to_send_to_gateway)
